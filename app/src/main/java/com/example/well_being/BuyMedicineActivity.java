...
public class BuyMedicineActivity extends AppCompatActivity {
    private String[][] packages =
            {
                    {"Uprise-D3 1000IU Capsule", "", "", "", "214"},
                    {"HealthVit Chromium Picolinate 200mcg Capsule", "", "", "", "321"},
                    {"Vitamin B Complex Capsules", "", "", "", "428"},
                    {"Inlife Vitamin E Wheat Germ Oil Capsule", "", "", "", "535"},
                    {"Dolo 650 Tablet", "", "", "", "107"},
                    {"Crocin 650 Advance Tablet", "", "", "", "428"},
                    {"Strepsils Medicated Lozenges for Sore Throat", "", "", "", "321"},
                    {"Tata 1mg Calcium + Vitamin D3", "", "", "", "214"},
                    {"Feronia -XT Tablet", "", "", "", "749"},
            };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<packages.length;i++){
            ...
            item.put( "line5", "Total Cost:"+"Rs."+packages[i][4]);
            list.add( item );
        }
